                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-white/80 backdrop-blur-lg shadow-xl rounded-2xl p-8 border border-green-100 transition hover:shadow-2xl hover:-translate-y-1 duration-200">
                        ...
                        <div class="mt-8 flex space-x-3">
                            <a href="{{ route('retail.orders.create') }}" class="inline-flex items-center px-5 py-2 bg-gradient-to-r from-green-500 to-green-600 border border-transparent rounded-lg font-bold text-xs text-white uppercase tracking-widest shadow hover:from-green-600 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 transition">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" /></svg>
                                Place New Order
                            </a>
                            <a href="{{ route('retail.orders.index') }}" class="inline-flex items-center px-5 py-2 bg-gray-100 border border-gray-200 rounded-lg font-bold text-xs text-gray-800 uppercase tracking-widest shadow hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 transition">
