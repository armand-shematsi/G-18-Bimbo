                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            <a href="{{ route('distributor.routes') }}" class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('distributor.routes') ? 'border-indigo-400 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} text-sm font-medium leading-5 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">Routes</a>
                            <a href="{{ route('distributor.vehicles') }}" class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('distributor.vehicles') ? 'border-indigo-400 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} text-sm font-medium leading-5 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">Vehicles</a>
                            <a href="{{ route('distributor.deliveries') }}" class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('distributor.deliveries') ? 'border-indigo-400 text-gray-900' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} text-sm font-medium leading-5 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out">Deliveries</a>
                        </div>
                    </div>
                    <!-- Settings Dropdown -->
