...
<div class="max-w-xl mx-auto">
    <form method="POST" action="{{ route('bakery.batches.store') }}">
        ...
        <div class="mb-4">
            ...
            <input type="datetime-local" name="actual_start" id="actual_start" value="{{ old('actual_start') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
        ...
        <div class="mb-4">
            ...
            <input type="datetime-local" name="actual_end" id="actual_end" value="{{ old('actual_end') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
